...
const ScrollComponent = ({ scrollPosition }) => {
  return (
    <div className="fixed flex items-center justify-center bottom-0 py-1.5 text-lg font-bold uppercase rounded-t-xl px-4 bg-[#b76e79] -translate-x-1/2 left-1/2">
...
function App() {
  ...
  return (
    ...
    >
      ...
      <div className="relative h-screen text-white snap-start">
        <DateComponent />
      </div>
    </div>
  );
